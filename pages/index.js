...
export default function Home() {
  return (
    <Layout home>
      ...
      <div className={`${styles.homeHeader} text-center text-white`}>
          ...
          <div className="row g-0 align-items-center">
            ...
            <div className="col-lg-8">
              <div className="card-body stand-out">
                ...
                <p className="card-text">
                  Recently, I have completed an online Data Science Bootcamp
                  that focused on Python for Data analysis, machine learning,
                  regression, and SQL. There, I started to develop a portfolio
                  based around data analytics.
                </p>
                <p className="card-text">
                  Now, I am working on my data visualization skills with
                  Tableau, working out SQL questions on LeetCode, and practicing
                  for interviews.
                </p>
                <p className="card-text">
                  Check out my portfolio for some projects that I found
                  interesting to do.
                </p>
              </div>
            </div>
