    ...
    <div className={styles.container}>
      ...
      {home ? (
        <header className={styles.homeHeader}>
          <h1 className={utilStyles.heading2Xl}>I'm {name}</h1>
          <h3>Data Analyst</h3>
          <div className="my-5">
              <a className="mr-3" href="https://www.linkedin.com/in/moises--figueroa" target="_blank">
              ...
              <a className="mr-3" href="https://github.com/mf11y" target="_blank">
              ...
              <a href="https://public.tableau.com/profile/moises.figueroa#!/" target="_blank">
